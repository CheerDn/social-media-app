...
function Chat() {
  ...
  */
  ...
  // Ref is the react way to do this imperatively.
  useEffect(() => {
  ...
  useEffect(() => {
    socket.current = io(process.env.BACKENDURL || "https://socialmediaappbycheer.herokuapp.com/")
  ...
  function handleFieldChange(e) {
    // A Synthetic event is not available once you're in another function deep,
    // so you need a const to hold the value.
